...
/*
	QSPI_Receive_IO and QSPI_Receive_O functions are differ by method of transmit only.
	An adress tranmits by 4 pins in _IO and consistently by IO0 in _O
*/
